classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Multivariable-Derivatives";
        ImagePath {mustBeFile} = fullfile("Images","SeaSurfaceGradient.png"); 
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.CoverImage.ImageSource = 'SeaSurfaceGradient.png';
